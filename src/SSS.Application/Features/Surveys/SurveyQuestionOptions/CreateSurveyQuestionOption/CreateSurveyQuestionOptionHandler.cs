...
{
    public class CreateSurveyQuestionOptionHandler(IAppDbContext db, IMapper mapper, ICacheService cacheService) : IRequestHandler<CreateSurveyQuestionOptionCommand, CreateSurveyQuestionOptionResponse>
    {
